            ...
            <div class="slideshow">
                ...
                <div class="slide-text">
                    ...
                    <div class="slide-image">
                        <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:690:300/q:90/plain/https://dashboard.cellphones.com.vn/storage/iphone-16-pro-max-8-3.jpg" alt="iPhone 16 Pro Max">
                    </div>
                </div>
                <div class="slide">
                <div class="slide-text">
                ...
                <div class="slide-text">
                    ...
                    <div class="slide-image">
                        <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:690:300/q:90/plain/https://dashboard.cellphones.com.vn/storage/s25-xanh-duong-8-3-kv-hang.png" alt="iMac">
                    </div>
                </div>
                <div class="slide">
                <div class="slide-text">
                    ...
                    <?php
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                echo "<div class='product1-item1' data-id='" . $row["ma_sp"] . "'>";
